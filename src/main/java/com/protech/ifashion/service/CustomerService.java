package com.protech.ifashion.service;
...
import com.protech.ifashion.dto.Item;
import com.protech.ifashion.dto.Product;
import com.protech.ifashion.dto.ShoppingCart;
...
public class CustomerService {
	...
	Customer customer=(Customer) session.getAttribute("customer");
	if(customer==null || customer.getCart()==null || customer.getCart().getItems()==null || customer.getCart().getItems().isEmpty())
	{
